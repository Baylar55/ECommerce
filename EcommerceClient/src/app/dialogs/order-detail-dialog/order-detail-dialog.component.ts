...
export class OrderDetailDialogComponent extends BaseDialog<OrderDetailDialogComponent> implements OnInit{
  constructor(dialogRef: MatDialogRef<OrderDetailDialogComponent>,
    @Inject(MAT_DIALOG_DATA) public data: OrderDetailDialogState | string, private orderService: OrderService, private dialogService: DialogService, private spinner: NgxSpinnerService, private toastr: CustomToastrService) {
    super(dialogRef);
  }
  ...
  completeOrder(){
    this.dialogService.openDialog({
      ...
      afterClosed: async () => {
        ...
        this.toastr.message("Order completed successfully", "Order Notification",{
