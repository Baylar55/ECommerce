...
export class RegisterComponent extends BaseComponent implements OnInit{
  ...
  constructor(private formBuilder: FormBuilder, private userService: UserService, private customToastrService:CustomToastrService, spinner: NgxSpinnerService) {super(spinner) }
