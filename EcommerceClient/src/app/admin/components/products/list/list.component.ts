...
export class ListComponent extends BaseComponent implements OnInit{
 ...
 async getProducts(){
  ...
  const allProducts: {totalProductCount: number, products: List_Product[]} = await this.productService.read(this.paginator ? this.paginator.pageIndex : 0, this.paginator ? this.paginator.pageSize : 0, ()=>this.hideSpinner(SpinnerType.BallAtom), errorMessage=>
