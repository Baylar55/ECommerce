...
export class ProductService {
  ...
  async read(page: number = 0, size: number = 8, successCallBack?: ()=> void, errorCallBack?: (errorMessage: string)=> void): Promise<{totalProductCount: number, products: List_Product[]}>{
